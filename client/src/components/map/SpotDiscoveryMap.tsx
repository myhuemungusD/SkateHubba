...
export default function SpotDiscoveryMap({
  userLat,
  userLng,
  onSpotSelect,
}: SpotDiscoveryMapProps) {
  ...
  useEffect(() => {
    ...
    // Initialize map
    const centerLat = userLat || 33.987;
    const centerLng = userLng || -118.468;
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {selectedSpot.type === "legendary" && <span className="text-yellow-400"></span>}
                  </div>
